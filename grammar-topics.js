...
const GRAMMAR_TOPICS = [
  ...
  {key:"om_te_infinitief", label:"om ... te + infinitief", hint:"purpose construction \"om ... te\" + infinitive (in order to) -- the infinitive goes at the very end -- e.g. \"Ik leer Nederlands om hier te wonen.\" (I'm learning Dutch in order to live here)", minCefr:3},
  {key:"hoeven", label:"hoeven (niet hoeven te)", hint:"\"hoeven\" is the negative counterpart of \"moeten\": used ALMOST ALWAYS with \"niet/geen\" to mean \"don't need to\" -- NOT the same as \"mogen niet\" (not allowed to) -- e.g. \"Je hoeft niet te komen.\" (You don't need to come) vs. \"Je mag niet komen.\" (You're not allowed to come)", minCefr:3},
  {key:"betrekkelijke_bijzin", label:"Betrekkelijke bijzin (die/dat)", hint:"relative clause: \"die\" refers back to a de-word/plural, \"dat\" refers back to a het-word -- the clause itself pushes its verb to the end (like any bijzin) -- e.g. \"de man die daar woont\" (the man who lives there), \"het boek dat ik lees\" (the book that I'm reading)", minCefr:3,
    variants: [
  ...
  {key:"aan_het_infinitief", label:"aan het + infinitief (bezig zijn met)", hint:"progressive-like construction: \"zijn\" + \"aan het\" + infinitive, stresses an action IN PROGRESS right now -- more explicit than the plain present tense -- e.g. \"Ik ben aan het koken.\" (I'm (in the middle of) cooking) vs. plain \"Ik kook.\" (I cook / I'm cooking, more neutral)", minCefr:3},
  {key:"elkaar", label:"elkaar (wederkerig)", hint:"\"elkaar\" (each other/one another) for reciprocal actions between two or more people -- distinct from \"zich\" (oneself) -- e.g. \"Zij houden van elkaar.\" (They love each other), \"Wij helpen elkaar.\" (We help each other)", minCefr:3},
  {key:"onbepaalde_vnw_uitgebreid", label:"iets/niets + bijvoeglijk naamwoord (+s)", hint:"after \"iets/niets/wat/veel\" etc., an adjective used as a modifier takes an extra -s -- a small but very common pattern -- e.g. \"iets leuks\" (something fun), \"niets bijzonders\" (nothing special), \"iets nieuws\" (something new)", minCefr:3},
  {key:"tijd_manier_plaats", label:"Volgorde: tijd - manier - plaats", hint:"when a clause has multiple adverbial elements (time, manner, place), Dutch word order is TIME before MANNER before PLACE -- e.g. \"Ik ga morgen met de trein naar Utrecht.\" (tomorrow=time, met de trein=manner, naar Utrecht=place) -- opposite order from what many other languages use", minCefr:3},
  {key:"twee_object_volgorde", label:"Twee objecten: volgorde (woordvolgorde met voornaamwoorden)", hint:"when a sentence has both a direct and an indirect object, and one or both are pronouns, the pronoun(s) move earlier -- e.g. \"Ik geef het boek aan haar.\" (neutral) -> \"Ik geef het haar.\" (both pronouns, direct object pronoun comes first) -- e.g. \"Ik geef haar het boek.\" (indirect object first, without \"aan\") is also possible with full nouns", minCefr:3},
  {key:"passief_basis", label:"Passief (basis): worden + voltooid deelwoord", hint:"basic present/past passive voice: \"worden\" (present) or \"werden\" (past) + past participle, used when the focus is on the ACTION happening to something rather than who does it -- e.g. \"Het huis wordt gebouwd.\" (The house is being built), \"De brief werd verstuurd.\" (The letter was sent)", minCefr:3},
];
